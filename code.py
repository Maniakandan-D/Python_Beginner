a, b = [int(a) for a in (input("Enter a two value: ").split())]
print("Number of Boys: ", a)
print("Number of Girls: ", b)
print()
# three value
a, b, c = [int(a) for a in (input("Enter a three value: ").split())]
print("Total number of student : ", a)
print("Number of Boys is : ", b)
print("Number of Girls is : ", c)
print()
# two inputs
a, b = [int(a) for a in (input("Enter a four value: ").split())]
print(f'First number is {a} and second number is {b}')
print()
# multiple inputs
a = [int(a) for a in (input("Enter a multiple value: ").split())]
